...
public class IngredienteController {
	...
	public String addIngrediente(@Valid @ModelAttribute("ingrediente") Ingrediente ingrediente, @PathVariable("id") Long id, BindingResult bindingResult, Model model) {
	...
	*/
	...
	//@PathVariable("id") indica che il parametro Long id proviene dal parametro in /ingrediente/{id}
	...
	public String confirmDeleteIngrediente(@PathVariable("id") Long id, Model model) {
		...
		//bisogna prima rimuovere l'ingrediente da tutti i piatti che lo contengono e poi provare a levarlo dalla base di dati (sennò dà errore)
	...
	public String editIngrediente(@PathVariable Long id, @Valid @ModelAttribute("Ingrediente") Ingrediente ingrediente, Model model, BindingResult bindingResults) {
