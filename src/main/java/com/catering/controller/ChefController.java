...
public class ChefController {
	...
	//@PathVariable("id") indica che il parametro Long id proviene dal parametro in /chef/{id}
	@GetMapping("/chef/{id}")
	...
	public String editChef(@PathVariable Long id, @Valid @ModelAttribute("chef") Chef chef, Model model, BindingResult bindingResults) {
