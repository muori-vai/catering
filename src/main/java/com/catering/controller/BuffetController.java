...
public class BuffetController {
	...
	public String addBuffet(@Valid @ModelAttribute("buffet") Buffet buffet, @PathVariable("id") Long id, BindingResult bindingResult, Model model) {
	...
	//@PathVariable("id") indica che il parametro Long id proviene dal parametro in /buffet/{id}
	...
	public String confirmDeleteBuffet(@PathVariable("id") Long id, /*@RequestParam(value="action", required=true) String action,*/ Model model) {
	...
	public String editBuffet(@PathVariable Long id, @Valid @ModelAttribute("Buffet") Buffet buffet, Model model, BindingResult bindingResults) {
