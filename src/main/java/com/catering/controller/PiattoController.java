...
public class PiattoController {
	...
	public String addPiatto(@Valid @ModelAttribute("piatto") Piatto piatto, @PathVariable("id") Long id, BindingResult bindingResult, Model model) {
	...
	//@PathVariable("id") indica che il parametro Long id proviene dal parametro in /piatto/{id}
...
//	}
	...
	public String confirmDeletePiatto(@PathVariable("id") Long id, /*@RequestParam(value="action", required=true) String action,*/ Model model) {
	...
	public String editPiatto(@PathVariable Long id, @Valid @ModelAttribute("Piatto") Piatto piatto, Model model, BindingResult bindingResults) {
